...
From skimming my data, I notice that I must proceed with the following data wrangling steps: \* Filter out responses outside of the business task scope (from self-employed folks) \* Rename column names \* Remove outliers by age \* Reformat gender responses \* Reformatting mixed job titles \* Renaming remote work categories
...
To answer the three questions for analysis, I split up the survey results thematically as stated below: 1. Current mental health offer at tech companies: Info on mental health resources available + observed responses at work 2. Status of employees' mental health at tech companies: Info on personal and family mental health history 3. Most recurrent attitudes towards mental health in the tech work space: Info on perceptions of mental health at work + perceptions of mental health on professional career
...
## 9. Summary of Data Intepretation
